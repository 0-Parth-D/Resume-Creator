...
class EducationController extends Controller
{
	...
	{
		// Assuming Education is the model associated with this controller
		$model = Education::model()->findByAttributes(array('student_id' => $id));
	
		if (isset($_POST['Education'])) {
			$model->attributes = $_POST['Education'];
	
			if ($model->save()) {
				// Redirect to another form or page after successfully saving the information
				$this->redirect(array('workExperience/create', 'id' => $id));
			}
		}
		else{
