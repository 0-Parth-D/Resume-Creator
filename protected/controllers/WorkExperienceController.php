...
class WorkExperienceController extends Controller
{
	...
	{
		$model= WorkExperience::model()->findByAttributes(array('student_id' => $id));
		...
		if(isset($_POST['WorkExperience']))
		{
			...
			if($model->save())
				$this->redirect(array('skills/create', 'id' => $id));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('WorkExperience');
	 ...
	 * @param WorkExperience $model the model to be validated
	 */
